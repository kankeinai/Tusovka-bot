...
TRANSLATIONS = {
    'ru': {
        ...
        'not_invited': '❌ Вы не приглашены\n\n Используйте /confirm для подтверждения приглашения',
        ...
        'grade_title' : '📊 **Оценка:**\n\n{grade}',
        'name_update_cancelled': '❌ Отмена обновления имени',
        'num_uses':'Введите максимальное количество использований кода',
    ...
    'en': {
        ...
        'not_invited': '❌ You are not invited\n\nUse /confirm to confirm invitation',
        ...
        'grade_title' : '📊 **Grade:**\n\n{grade}',
        'name_update_cancelled': '❌ Name update cancelled',
        'num_uses':'Enter number of uses for the invite code:',
    ...
    'fi': {
        ...
        'not_invited': '❌ Et ole kutsumassa\n\nKäytä /confirm kutsumisen vahvistamiseen',
        'menu_title': '⚙️ Asetukset',
        'registration_cancelled': '❌ Rekisteröityminen peruttu',
        'already_registered': '❌ Olet jo rekisteröitynyt',
        'change_name': '✏️ Muuta nimeä',
        'invite_code_created': '✅ Kutsumiskoodi luotu',
        ...
        'name_update_cancelled': '❌ Nimi päivitetty',
        'num_uses':'Syötä kutsumiskoodin käyttömäärä:',
        'not_admin':'❌ Sinä et ole admin'
    },
    'kz': {
        ...
        'not_invited': '❌ Сіз шақырылмағансыз\n\nШақыруды растау үшін /confirm пайдаланыңыз',
        'menu_title': '⚙️ Параметрлер',
        'registration_cancelled': '❌ Тіркелу тоқтатылды',
        'invite_code_created': '✅ Шақыру коды жасады',
        ...
        "name_update_cancelled": "❌ Ат өзгертуі тоқтатылды",
        'num_uses':'Шақыру кодының қолдану санын енгізіңіз:',
        'not_admin':'❌ Сіз админ емессіз'
    }
}
